...
import 'package:grocery_delivery_boy/data/repository/chat_repo.dart';
...
class ChatProvider with ChangeNotifier {
  ...
  Future<http.StreamedResponse> sendMessage(
      String message, List<XFile> file, int? orderId) async {
    _isLoading = true;
    notifyListeners();
    http.StreamedResponse response =
        await chatRepo!.sendMessage(message, file, orderId);
