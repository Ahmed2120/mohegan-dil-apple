...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key? key, this.orderModel, this.orderid, this.argument})
      : super(key: key);
  @override
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  void initState() {
    super.initState();
    widget.orderModel!.id == widget.argument?.param;
                ...
                child: ClipRRect(
                  ...
                  child: FadeInImage.assetNetwork(
                    ...
                    imageErrorBuilder: (c, t, o) =>
                        Image.asset(Images.placeholderImage, fit: BoxFit.cover),
                  ),
                ),
              ),
            )
      ...
      body: Column(
        children: [
          Consumer<ChatProvider>(
              builder: (context, chatProvider, child) => Expanded(
                        ...
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return MessageBubble(
                                  messages: chatProvider.messages[index]);
                            })
                        : const SizedBox(),
                  )),
          Container(
                    ...
                    return InkWell(
                      onTap: () async {
                        if (Provider.of<ChatProvider>(context, listen: false)
                            .isSendButtonActive) {
                          chatPro
                              .sendMessage(_inputMessageController.text.trim(),
                                  chatPro.chatImage, widget.orderModel!.id)
                              .then((value) {
