...
import 'package:grocery_delivery_boy/data/model/body/delivery_man_body.dart';
...
class AuthRepo {
  ...
  Future<ApiResponse> deleteAccount() async {
    try {
      ...
      Response response = await dioClient!.post(
        AppConstants.removeAccount,
        data: {"token": sharedPreferences!.get(AppConstants.token)},
      );
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
  ...
  Future<http.Response> registerDeliveryMan(DeliveryManBody deliveryManBody, List<MultipartBody> multiParts) async {
